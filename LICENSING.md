...
STYLiTE Orbit Monitor is **source-available** software, licensed under the
...
| Build and run it to scan and monitor **your own** networks / your own organization's | ✅ Yes |
...
| Use case | Allowed under BSL? |
| --- | --- |
| Offer Orbit Monitor to **third parties** as a hosted / managed / multi-tenant service | ❌ Needs a commercial license |
| Scan and monitor **your customers'** networks with it as a paid service (MSP use) | ❌ Needs a commercial license |
...
> **Note:** This grant only covers networks and hosts you are **authorized** to
> scan. Port scanning and vulnerability assessment of systems you do not own or
> have explicit permission to test may be illegal regardless of this License.
...
same time, the hosting and commercial resale of Orbit is how STYLiTE funds its
...
to the names or logos — a permitted fork must be distributed under a different
name.
